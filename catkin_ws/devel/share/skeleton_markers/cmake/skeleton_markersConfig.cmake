...
if("TRUE" STREQUAL "TRUE")
  set(skeleton_markers_SOURCE_PREFIX /home/natalia/multi-camera/catkin_ws/src/skeleton_markers)
  set(skeleton_markers_DEVEL_PREFIX /home/natalia/multi-camera/catkin_ws/devel)
  ...
  set(skeleton_markers_INSTALL_PREFIX /home/natalia/multi-camera/catkin_ws/install)
...
if(NOT "/home/natalia/multi-camera/catkin_ws/devel/include " STREQUAL " ")
  set(skeleton_markers_INCLUDE_DIRS "")
  set(_include_dirs "/home/natalia/multi-camera/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/skeleton_markers " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/skeleton_markers' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'skeleton_markers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'skeleton_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/natalia/multi-camera/catkin_ws/src/skeleton_markers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT skeleton_markers_NUM_DUMMY_TARGETS)
      set(skeleton_markers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::skeleton_markers::wrapped-linker-option${skeleton_markers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR skeleton_markers_NUM_DUMMY_TARGETS "${skeleton_markers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::skeleton_markers::wrapped-linker-option${skeleton_markers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND skeleton_markers_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(skeleton_markers_EXPORTED_TARGETS ${${skeleton_markers_dep}_EXPORTED_TARGETS})
endforeach()
